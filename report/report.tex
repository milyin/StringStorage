...
\begin{minted}[frame=single,fontsize = \footnotesize, linenos, xleftmargin = 1.5em]{}
mkdir build
cd build
cmake ..
...
\begin{minted}[frame=single,fontsize = \footnotesize, linenos, xleftmargin = 1.5em]{sh}
set NODE_SIZE=%1
set INPUT_SIZE=%2
...
Реализация была проанализирована на быстродействие. По результатам тестирования были определены проблемы, ограничивающие функциональность текущей реализации и определены пути для дальнейшего развития.
